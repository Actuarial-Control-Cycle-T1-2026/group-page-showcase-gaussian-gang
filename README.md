...
# Data
No additional data sources were considered for this analysis. For the data provided the following limitations have been identified:  

- There was no available information on the environmental conditions of BS and OD. This required assumptions to be derived from the qualitative description which may distort the accuracy of model outputs. 
- The limited information provided on CQMC’s personnel and inventory compromised the ability to segment, model and price homogenous risk groups.  
- In the available data, no claim occurrence date was provided. As historical experience may not reflect current exposure, the inclusion of all claims may skew the aggregate loss distributions. 
